...
- Skill 区保持原有 CSS Grid 瀑布流，不使用 1+2 主次网格：宽屏 4 列、1180px 以下 3 列、860px 以下 2 列、620px 以下 1 列；`medium`、`large`、`tall` 继续使用不同 row span 形成高低错落。紧凑覆盖将 span 收紧为 42/48/54，列间距和卡片底部间距为 14px，移动端封面为 248px。
